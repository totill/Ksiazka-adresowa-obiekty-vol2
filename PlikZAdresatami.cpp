...
//    bool czyIstniejeAdresat = false;
    ...
    if (odczytywanyPlikTekstowy.good() == true && adresat.pobierzId() != 0)
    {
        while (getline(odczytywanyPlikTekstowy, wczytanaLinia))
        {
            ...
            {
//                numerWczytanejLinii = idAdresata;
//                numerWczytanejLinii++;
            }
            else if (numerWczytanejLinii == 1 && numerWczytanejLinii != adresat.pobierzId())
                tymczasowyPlikTekstowy << wczytanaLinia;
            else if (numerWczytanejLinii == 2 && adresat.pobierzId() == 1)
                tymczasowyPlikTekstowy << wczytanaLinia;
            else if (numerWczytanejLinii > 2 && adresat.pobierzId() == 1)
                tymczasowyPlikTekstowy << endl << wczytanaLinia;
            else if (numerWczytanejLinii > 1 && adresat.pobierzId() != 1)
                tymczasowyPlikTekstowy << endl << wczytanaLinia;
